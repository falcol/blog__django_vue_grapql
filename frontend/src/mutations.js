...
export const UPDATE_USER_PROFILE = gql`
    mutation ($userID: ID!, $firstName: String!, $lastName: String!, $avatar: Upload!, $bio: String!, $location: String!, $website: String!) {
        updateUserProfile(userId: $userID, firstName: $firstName, lastName: $lastName, avatar: $avatar, bio: $bio, location: $location, website: $website) {
            user {
                id
                username
                firstName
