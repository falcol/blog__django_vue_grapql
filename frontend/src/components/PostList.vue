                        ...
                        <div class="space-y-5 xl:col-span-3">
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <router-link v-if="post.category" class="text-sm font-medium uppercase text-teal-500 hover:underline hover:text-teal-700" :to="`/category/${post.category.slug}`">{{
                                        post.category.name
                                    }}</router-link>
                                </div>
                            ...
                            <div class="text-base font-medium leading-6">
                                <router-link class="text-teal-500 hover:underline hover:text-teal-700" :to="`/post/${post.slug}`">Read more →</router-link>
                            </div>
                        </div>
                    </div>
                </article>
